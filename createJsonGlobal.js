...
download('http://www.w3school.com.cn/tags/html_ref_standardattributes.asp',function(data){
    ...
    setTimeout(function(){//......
        ...
        for(var j in globalJson.global){
            obj.dataFields.push({name:globalJson.global[j],type:'string'})
        }
        fs.writeFileSync('C:\\Users\\Oscar.Hogan-PC\\Desktop\\form-creator\\global.json',JSON.stringify(obj));
    },2000);
